...
-- private.has_role is the canonical RBAC helper. This migration is ordered
-- after 20260824034153_harden_rbac_helper_search_paths so the helper exists
-- before these policies are parsed on a fresh replay.
