...
create or replace function private.authorize_application_handoff_internal(_user_id uuid, _lender_product_id uuid, _requested_amount numeric, _term_months integer, _signature_name text)
returns public.application_handoffs
language plpgsql security definer set search_path = ''
as $$
declare
  v_product public.bank_products; v_profile_full_name text; v_handoff public.application_handoffs;
  v_authorized_at timestamptz := clock_timestamp(); v_authorization_text text; v_authorization_hash text;
begin
...
returns public.application_handoffs language sql security invoker set search_path = ''
...
revoke execute on function public.authorize_application_handoff(uuid,numeric,integer,text) from public,anon;
