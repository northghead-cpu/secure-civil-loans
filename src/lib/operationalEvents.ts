 ...
 *
 * Operational events are deliberately kept separate from customer data. The
 * same scrubber used by Sentry is applied before anything is sent upstream.
 * This module records telemetry; it does not create UI or incident workflows.
 */
