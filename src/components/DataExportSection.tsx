 ...
 * record we hold about them (profile, KYC, loan applications, payouts,
 * payroll authorizations, consent trail). RLS scopes every query to
 * auth.uid(), so nothing outside the caller's own data can leak.
 */
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-foreground/90 leading-relaxed">
          Under Section 38 of the Data Protection Act 2021, you can obtain a
          machine-readable copy of every record we hold about you — profile,
          KYC submissions, loan applications, payouts, and consent history.
          The file downloads directly to your device as JSON.
        </p>
